...
public class FHsort
{
    ...
    /**
     * In FHsort.java add the static mutator FHsort.setRecursionLimit(int) which you will use to change
     * this limit to any int value in the range of 2 to 300. In this project, the goal is to find the
     * optimal recursion limit arrays of various sizes
     * @param newLim
     * @return
     */
    //In FHsort.java add the static mutator FHsort.setRecursionLimit(int) which you will use to change
